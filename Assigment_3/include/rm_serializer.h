 ...
 * Function: attrOffset
 * --------------------
 * Calculates the offset (in bytes) of a given attribute in a record,
 * based on the table's schema.
 *
 * Parameters:
 *   schema  - Pointer to the Schema structure.
 *   attrNum - Attribute number (index) for which to calculate the offset.
 *   result  - Pointer to an integer where the offset will be stored.
 *
 * Returns:
 ...
 *
 * These functions convert various data structures into their string
 * representations.
 */
 ...
 *
 * These functions convert string representations back into their
 ...
 * Helper Functions:
 *
 * Additional utility functions for parsing and manipulating string data.
 */
